...
class Database{
     ...
     * Database class
     */
     private $db_host = "sql109.byethost8.com";  // Change as required
     private $db_user = "b8_21086127";  // Change as required
     private $db_pass = "cle546546ver";  // Change as required
     private $db_name = "b8_21086127_teste_db";    // Change as required

   // private $db_host = "localhost";  // Change as required
   // private $db_user = "root";  // Change as required
   // private $db_pass = "";  // Change as required
   // private $db_name = "bkp_agenda";    // Change as required
    ...
    public function connect(){
      if(!$this->con){
            ...
            if($this->myconn->connect_errno > 0){
                ...
                if (!$this->myconn->set_charset("utf8")) {
    ...
    public function delete($table,$where = null){
      ...
      if($this->tableExists($table)){
       ...
       if($where == null){
                $delete = 'TRUNCATE '.$table; // Create query to delete table
            }else{
